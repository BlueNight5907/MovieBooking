...
import { EmailRounded, Google, LinkedIn, Lock, LockOutlined, Person, Twitter, VpnKey } from '@mui/icons-material'
            ...
            <AuthWrapper className={(isLogin?"":"sign-up-mode")}>
                ...
                <PanelWrapper>
                    <Panel sx={classes.leftPanel} className="left-panel">
                        ...
                        <PanelImage src="/assets/images/background/log.svg" className="image" alt="" />
                    </Panel>
                    <Panel sx={classes.rightPanel} className="right-panel">
                        ...
                        <PanelImage src="/assets/images/background/register.svg" className="image" alt="" />
                    </Panel>
                </PanelWrapper>
            </AuthWrapper>
        </Fragment>
